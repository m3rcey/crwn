...
export function AuthForm({ mode, onSuccess, onSignupComplete, pendingResultToken, pendingNext }: AuthFormProps) {
  ...
  if (showConfirmation) {
    return (
      <div className="w-full max-w-md mx-auto text-center py-8">
        ...
        <h3 className="text-xl font-semibold text-crwn-text mb-2">Check Your Email</h3>
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      {/* Google first: one tap instead of five fields, and it keeps the form above the fold on the
          calculator signup screens. The email form stays below as the secondary path. */}
      <div className="mb-5">
        <button
          type="button"
          onClick={() => signInWithGoogle(pendingNext)}
          className="w-full flex items-center justify-center gap-2 py-3.5 rounded-full bg-white text-black font-semibold"
        >
        ...
        <div className="relative mt-5">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-crwn-surface text-crwn-text-secondary">Or use your email</span>
          </div>
        </div>
      </div>
