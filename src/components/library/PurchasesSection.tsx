...
import { Purchase, BookingToken, Product } from '@/types';
...
export function PurchasesSection() {
  ...
  // Separate experience purchases from others
  const experiencePurchases = purchases.filter(p => p.products?.type === 'experience');
  const otherPurchases = purchases.filter(p => p.products?.type !== 'experience');
