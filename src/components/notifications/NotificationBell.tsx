...
export function NotificationBell() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="fixed left-2 right-2 bottom-16 md:absolute md:left-0 md:right-auto md:bottom-auto md:top-full md:mt-2 w-auto md:w-80 bg-crwn-surface border border-crwn-elevated rounded-xl shadow-xl z-50 overflow-hidden animate-slide-up-notif">
