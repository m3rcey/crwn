...
import {
  ...
  Loader2, MapPin, Star, UserCheck, UserX,
} from 'lucide-react';
...
export function AudienceTab() {
  ...
  useEffect(() => {
    setPage(1);
  }, [debouncedSearch, tierFilter, locationFilter, engagementFilter]);
  ...
  const formatLocation = (fan: AudienceFan) => {
    const parts = [fan.city, fan.state, fan.country].filter(Boolean);
