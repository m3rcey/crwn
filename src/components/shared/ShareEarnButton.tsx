...
export function ShareEarnButton({ artistSlug, artistId, commissionRate }: ShareEarnButtonProps) {
  ...
  const referralUrl = `https://thecrwn.app/${artistSlug}?ref=${referralCode}`;
  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-1.5 px-4 py-2 rounded-full text-sm bg-green-500 text-white font-medium hover:bg-green-600 transition-colors"
      >
