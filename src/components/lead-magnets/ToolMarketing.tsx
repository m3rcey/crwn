...
function Eyebrow({ children }: { children: React.ReactNode }) {
  return <p className="text-[11px] uppercase tracking-[0.2em] text-crwn-gold font-semibold mb-3">{children}</p>;
}
...
export function ToolMarketing({ slug, completed = false }: { slug: string; completed?: boolean }) {
  ...
  return (
    <div className="mt-16 space-y-20 text-crwn-text">
      ...
      <section>
        <Eyebrow>One fan economy</Eyebrow>
