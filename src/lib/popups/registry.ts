...
export const POPUPS: PopupDef[] = [
  // ---- Artist: get paid (highest stakes, blocks money flow) ----
  {
    ...
    body: 'Every subscribe and every sale hits a dead end until payouts are connected. About five minutes.',
  ...
  // would have quietly starved the prompt of its most common surface.
  {
    ...
    body: 'A goal you are partway through pays nothing until it is finished. The last stretch is the short one.',
  ...
  // Losing that contest defers it: `everyN` keeps it eligible later rather than cancelling it.
  {
    ...
    body: 'Most artists never get a first paid member on CRWN. Know one still renting their fanbase? Send them their numbers.',
  ...
  // ---- Artist: first broadcast (activation, protects retention) ----
  {
    ...
    body: 'People backed you and have not heard a word since. Silence is why they forget to renew.',
  ...
  // below take over at the actual break-even lines.
  {
    ...
    body: `CRWN keeps ${TIER_LIMITS.starter.platformFeePercent} percent on Launch and ${TIER_LIMITS.pro.platformFeePercent} on Pro. Past $${usd(PRO_BREAK_EVEN)} a month, staying free costs you more.`,
  ...
  // accounts created after the change shipped (announcedAt), who met these limits as normal.
  {
    ...
    body: 'Launch used to cap you at 20 tracks and 100 members. It is now 50 tracks and NO member cap.',
  ...
  // that is the actual failure this fixes.
  {
    ...
    body: 'Your page looks unlocked because you own it, so a broken ladder stays invisible until the money does not arrive.',
  ...
  // only for music they can already stream is why memberships stall.
  {
    ...
    body: 'If your membership offers the same songs Spotify has, joining buys nothing. Your tiers screen now names the strategy that fits.',
  ...
  // Skipped for accounts created on or after announcedAt: they met the one-move screen at signup.
  {
    ...
    body: 'Four next moves is the same as none. Rise Mode now names ONE, and what comes after it. Nothing was removed.',
  ...
  // reads it, including the venue or brand the artist is trying to convince.
  {
    ...
    title: 'Your answer could be why someone else joins.',
    body: 'An artist you support asked what this has been like. Nobody sees your answer unless you allow it, and they can never change your words.',
  ...
  // and no Goals button, so announcing it would send artists looking for nothing.
  {
    ...
    body: 'The fans who show up live are the most willing to pay, and had no way to. Set a tip goal for your next stream.',
  ...
  // is still dark. Announce-once: a feature launch is news exactly one time.
  {
    ...
    body: 'Four kinds of royalty are already owed to you, and none of them pay out unless you are registered. Twelve questions show which have nobody assigned.',
  ...
  // looking for a control that isn't there. Loss-framed per the copy rule.
  {
    ...
    body: 'Being in the room while you work is what your fans want most, and it earns you nothing. Sell the seat.',
  ...
  // artist learned the old 16-tab strip and every one of them is affected.
  {
    ...
    body: 'Payouts, tiers and billing used to sit past the edge of your phone. The menu in the top left now lists every screen.',
  ...
  // because fans get stuck too. Loss-framed per the copy rule.
  {
    ...
    body: 'Every question you sit on is momentum lost. Support answers most of them instantly, and finds you a human when it cannot.',
