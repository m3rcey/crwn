...
const VAULT_REVENUE_PLANNER: LeadMagnetConfig = {
  ...
  category: 'Monetize',
  description: 'Turn the unreleased music sitting on your phone into a recurring supporter Vault.',
...
const PROOF_OF_DEMAND: LeadMagnetConfig = {
  ...
  category: 'Validate',
  description: 'Test fan demand before you spend on merch, shows, videos, or products.',
...
const FAN_MISSION: LeadMagnetConfig = {
  ...
  category: 'Engage',
  description: 'Turn a vague ask into one clear, trackable fan mission with a goal, deadline, and reward.',
...
const CLIP_TO_EARN: LeadMagnetConfig = {
  ...
  category: 'Grow',
  description: 'Turn your content into a structured fan clipping campaign with rules, moments, and rewards.',
