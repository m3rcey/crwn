export function artistNewSubscriberEmail(artistName: string, fanName: string, tierName: string, amount: string): string {
  return `
<!DOCTYPE html>
<html>
<head>
...
<body style="margin:0;padding:0;background-color:#1A1A1A;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
  <div style="max-width:600px;margin:0 auto;padding:40px 20px;">
    ...
    <div style="background-color:#242424;border-radius:16px;padding:32px;border:1px solid #333;">
      <h2 style="color:#FFFFFF;font-size:24px;margin:0 0 16px;">New Subscriber &#127881;</h2>
      <p style="color:#A0A0A0;font-size:16px;line-height:1.6;margin:0 0 24px;">
        Hey ${artistName}, someone just joined your community!
      </p>
      <div style="background-color:#1A1A1A;border-radius:12px;padding:20px;margin:0 0 24px;">
        <table style="width:100%;border-collapse:collapse;">
          ...
          <tr>
            <td style="color:#A0A0A0;font-size:14px;padding:8px 0;">Tier</td>
            <td style="color:#D4AF37;font-size:14px;padding:8px 0;text-align:right;font-weight:600;">${tierName}</td>
          </tr>
          <tr>
            <td style="color:#A0A0A0;font-size:14px;padding:8px 0;border-top:1px solid #333;">Monthly</td>
            <td style="color:#D4AF37;font-size:18px;padding:8px 0;text-align:right;font-weight:700;border-top:1px solid #333;">$${amount}/mo</td>
          </tr>
        </table>
      </div>
