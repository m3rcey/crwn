...
const ARTIST_SETUP: QuestTemplate[] = [
  ...
  },
  {
    ...
    subtitle: 'Give fans something to press play on',
    whyItMatters: 'A page with music converts. A page without it is a placeholder.',
    category: 'setup',
  ...
  },
  {
    ...
    title: 'Build your first supporter offer',
    subtitle: 'Choose an offer type and publish it',
    whyItMatters: 'You cannot earn from fans you cannot charge. This is the switch that turns attention into money.',
    category: 'offer',
    questType: 'main_quest',
    requiredRole: 'artist',
    difficulty: 'medium',
    ...
    steps: [
      { title: 'Choose an offer type' },
      { title: 'Set a price' },
      { title: 'Pick benefits' },
      { title: 'Publish' },
    ],
    completionCondition: { kind: 'domain', check: 'artist_has_offer' },
    reward: { xp: 100, badges: ['first_offer_built'], unlocks: ['supporter_leaderboard'], content: ['rise_feed_offer_post'] },
    canStreamLive: true,
    priorityScore: 280,
    sortOrder: 30,
