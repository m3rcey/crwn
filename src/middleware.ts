...
export async function middleware(request: NextRequest) {
  ...
  const protectedPaths = ['/home', '/explore', '/community', '/library', '/profile', '/setup', '/offers', '/proof-of-demand', '/missions', '/my-missions', '/earn', '/impact', '/command', '/clip-controls', '/recruit/dashboard', '/admin'];
  ...
  try {
    ...
    const knownRoutes = ['home', 'explore', 'community', 'library', 'profile', 'login', 'signup',
      ...
      'welcome', 'setup', 'offers', 'proof-of-demand', 'missions', 'my-missions', 'earn', 'impact', 'command', 'clip-controls', 'verify', 'reset-password', 'forgot-password', 'partner', 'join',
