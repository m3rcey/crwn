...
export function WorthExperience({ homepage = false }: { homepage?: boolean }) {
  ...
  const assumptionsBlock = (
    <>
      <div className="mt-6">
        <div className="text-base text-crwn-text-secondary mb-2">Assumptions</div>
      ...
      <button
        ...
        className="mt-4 flex items-center gap-1 text-base text-crwn-text-secondary hover:text-crwn-gold transition-colors"
      >
      ...
      {showAdvanced && (
        <div className="mt-4 space-y-5 border-t border-crwn-elevated pt-4">
          ...
          />
          <p className="text-base text-crwn-text-secondary/70">
  ...
  const statsGrid = hasNumber ? (
    <>
      ...
      <p className="text-base text-crwn-text-secondary/70 mt-4">
  ...
  const emailCaptureCard = (
    <div className={`bg-crwn-surface border border-crwn-elevated rounded-2xl p-6 ${homepage ? 'mb-6' : 'mb-14'}`}>
      {captureState === 'done' ? (
        ...
        <>
          <div className="text-center mb-4">
            ...
            <div className="text-lg text-crwn-text-secondary">
      ...
      <p className="text-center text-base text-crwn-text-secondary mt-3">
    ...
    <div className="min-h-screen bg-crwn-bg text-crwn-text">
      ...
      <div className={`max-w-3xl mx-auto px-4 page-fade-in ${homepage ? 'pt-6 pb-12 sm:pt-10 sm:pb-16' : 'py-12 sm:py-16'}`}>
        ...
        <div className={`text-center ${homepage ? 'mb-5' : 'mb-8'}`}>
          ...
          <p className={`text-crwn-text-secondary max-w-xl mx-auto text-lg ${homepage ? '' : 'sm:text-xl'}`}>
            {homepage
        ...
        <div className="bg-crwn-surface border border-crwn-elevated rounded-2xl p-6 mb-4">
          ...
          <p className="text-base text-crwn-text-secondary/70 mt-3">
        ...
        <section className="mb-14">
          ...
          <p className="text-crwn-text-secondary text-lg mb-5">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-3">
                    ...
                    {count != null && (
                      <span className="flex items-center gap-1 text-base text-crwn-text-secondary">
                  ...
                  <ul className="space-y-1.5">
                    {t.perks.map((p) => (
                      <li key={p} className="flex items-start gap-2 text-lg text-crwn-text-secondary">
        ...
        <section className="mb-14">
          ...
          <p className="text-crwn-text-secondary text-lg mb-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            {FAN_MATH.map((m) => (
              <div key={m.fans} className="bg-crwn-surface border border-crwn-elevated rounded-2xl p-5 text-center">
                ...
                <div className="text-base text-crwn-text-secondary mb-2">fans × $15/mo</div>
        ...
        <section className="mb-14">
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            {MONETIZE_WAYS.map((w) => (
              <div key={w.title} className="bg-crwn-surface border border-crwn-elevated rounded-2xl p-5">
                ...
                <p className="text-lg text-crwn-text-secondary leading-relaxed mb-3">{w.line}</p>
          ...
          <p className="text-crwn-text-secondary text-lg mt-6 mb-4">Your storefront, live in minutes:</p>
          <ShopMock />
        </section>
            ...
            {WATERFALL.map((w, i) => (
              <div key={w.day} className="flex gap-4">
                ...
                <div className={i < WATERFALL.length - 1 ? 'pb-5' : ''}>
                  ...
                  <p className="text-base text-crwn-text-secondary mt-1">{w.sub}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            {AUDIENCE_TOOLS.map((t) => (
              <div key={t.name} className="bg-crwn-surface border border-crwn-elevated rounded-2xl p-4">
                ...
                <p className="text-base text-crwn-text-secondary">{t.desc}</p>
              </div>
            ))}
          </div>
          <p className="text-crwn-text-secondary text-lg mt-6 mb-4">Set your automations once, they run forever:</p>
          <SequencesMock />
        </section>
        ...
        <section className="mb-14">
          ...
          <div className="bg-crwn-surface border border-crwn-elevated rounded-2xl p-6 mt-4">
            ...
            <div className="text-base text-crwn-text-secondary mt-2">Free plan keeps 88%. Pro keeps 92%. Every plan pays out straight to your bank.</div>
          </div>
        </section>
          ...
          <div className="space-y-3">
            {OBJECTIONS.map((o) => (
              <div key={o.q} className="bg-crwn-surface border border-crwn-elevated rounded-2xl p-5">
                ...
                <p className="text-lg text-crwn-text-secondary leading-relaxed">{o.a}</p>
              </div>
            ))}
          </div>
        </section>
          ...
          <div className="grid sm:grid-cols-3 gap-3">
            {STEPS.map((s) => (
              <div key={s.n} className="bg-crwn-surface border border-crwn-elevated rounded-2xl p-5">
                ...
                <p className="text-lg text-crwn-text-secondary">{s.body}</p>
              </div>
            ))}
          </div>
        </section>
          ...
          <div className="divide-y divide-crwn-elevated">
            {FAQS.map((f) => (
              <div key={f.q} className="py-4">
                ...
                <p className="text-lg text-crwn-text-secondary leading-relaxed">{f.a}</p>
              </div>
            ))}
          </div>
        </section>
...
function PrimaryCTA({ children, sub, homepage }: { children: ReactNode; sub?: string; homepage?: boolean }) {
  ...
  return (
    <div className="text-center my-12">
      ...
      {sub && <p className="text-base text-crwn-text-secondary mt-3">{sub}</p>}
    </div>
  );
}
        ...
        <div key={r.label} className="grid grid-cols-2">
          <div className="px-4 py-3 flex items-start gap-2 border-b border-crwn-elevated/60">
            ...
            <div>
              ...
              <div className="text-lg text-crwn-text-secondary">{r.streaming}</div>
            </div>
          </div>
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-1.5">
        <span className="text-lg text-crwn-text-secondary">{label}</span>
...
function Stat({ label, value }: { label: string; value: string }) {
  return (
    <div className="bg-crwn-bg/40 rounded-xl p-3">
      ...
      <div className="text-base text-crwn-text-secondary">{label}</div>
    </div>
  );
}
