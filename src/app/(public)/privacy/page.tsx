    ...
    <div className="min-h-screen bg-crwn-bg">
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-crwn-text-secondary">
          ...
          <p>We do not sell your personal information. We share with: Stripe (payments), Supabase (database/auth), Vercel (hosting), Resend (email delivery), ManyChat (Instagram and social messaging), Anthropic (AI processing of lead conversations), and as required by law or in business transfers.</p>
