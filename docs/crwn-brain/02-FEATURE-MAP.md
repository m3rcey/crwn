...
| Executive Producer Sessions | — | **Not built.** The `executive-producer-session` lead magnet sells it, and the audit (2026-07-24) found no submission table, no fan-to-artist upload, no artist review queue, and no mintable `stage` role. See `13-CURRENT-STATE.md` |
