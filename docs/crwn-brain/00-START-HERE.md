...
- **Platform tiers/fees (code SoT `TIER_LIMITS`):** Free 12% / **Pro $9.99 8%** (only billable v1) / $99 `label` 5% (spec-only) / `empire` dead. Founding artist = flat 5% for 6 months. (The PRD's $50/$175/$350 pricing is **stale**.)
