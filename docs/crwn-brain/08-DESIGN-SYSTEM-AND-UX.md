...
- Still pending from the handoff (see TODO "On Claude's plate"): setup-wizard composition, Studio Music/Fan CRM layout, calculator-intro pattern, ambient layer, player accent, CI contrast sweep.
