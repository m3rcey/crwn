## 50 CENT TOOK A PIECE INSTEAD OF A CHECK
...
1. 50 Cent's Smartest Deal Wasn't Music -- Structure 6  ← SUGGESTED
2. 50 Cent Took A Piece, Not A Paycheck -- Structure 8
3. The Water Deal That Beat Every Album -- Structure 6
4. Why 50 Cent Said No To The Flat Fee -- Structure 2
5. Would You Take The Piece Over The Check -- Structure 1

**TOPIC:** 50 Cent took a $5M fee plus ~10% equity in Vitamin Water instead of a flat endorsement check. Coca-Cola bought Glacéau for $4.1B in 2007; his stake reportedly netted $60-100M, more than his music. A one-time check ends; a piece of what you own pays when it grows.
...
Flat scan of a white sheet of paper filling the entire frame. No desk, no surface, no edges visible, just white paper. Black sharpie marker handwriting. The dominant central illustration: a giant Vitamin Water bottle in the center that has turned into a money fountain, spraying bills upward labeled "$60M-$100M", with a 50 Cent figure standing beside it smiling and catching the falling cash in his arms; on the ground at his feet lies a small torn one-time paycheck labeled "FLAT FEE" with a line crossing it out. Keep the supporting data beside the scene: "TURNED DOWN A FLAT FEE → TOOK $5M + EQUITY", "2007: COKE BOUGHT IT $4.1B → 50's PIECE ~$60M-$100M", "1 PIECE > EVERY ALBUM HE SOLD". At the very top in large hand-lettered black sharpie capitals (thick uneven hand-drawn marker strokes, NOT a printed, bold, or display font): "HE TOOK A PIECE", with "OFF WATER, NOT MUSIC" under it. At the bottom, smaller and circled: "A CHECK ENDS. A PIECE GROWS." The background is pure white (#FFFFFF). Shot perfectly straight on, no angle, no shadow, no background elements. Pure white paper fills the entire 3:4 frame edge to edge.

---

**PAN ORDER:**

1. "BIGGEST PAYDAY: NOT MUSIC" with bottle shape
2. "CHECK" vs "PIECE" circled
3. "FLAT FEE" crossed out, "$5M + EQUITY"
4. "OWNS PART" underlined
5. "COKE BUYS IT: $4,100,000,000" / "50's PIECE: ~$60M-$100M" connected
6. "1 PIECE > EVERY ALBUM" underlined twice
7. "CHECK = ONCE" / "PIECE = WHEN IT GROWS" circled at bottom
