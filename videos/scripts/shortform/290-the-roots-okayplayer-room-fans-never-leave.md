## THE ROOTS / OKAYPLAYER — THE ROOM FANS NEVER LEFT
...
1. The Roots Gave Fans A Room They Never Left -- Structure 4  ← SUGGESTED
2. The Roots Built A Room For Fans -- Structure 6
3. If Your Fans Only Got You, They Leave -- Structure 3
4. Fans Vs A Forum -- Structure 8
5. The Roots Built 25th Year A Forum -- Structure 7

**TOPIC:** The Roots launched Okayplayer in 1999, a fan forum where fans bonded with each other and stayed for decades; a room you host outlasts any one artist.
...
Flat scan of a white sheet of paper filling the entire frame. No desk, no surface, no edges visible, just white paper. Black sharpie marker handwriting. At the top in big bold capital letters: "HOW LONG WOULD THEY STAY?", and beside it a hand-drawn sharpie head-and-shoulders portrait capturing the recognizable likeness of The Roots (Questlove and Black Thought) from the attached photo reference, drawn in confident sharpie line work, not generic stick figures, labeled "THE ROOTS" underneath. Beneath the headline in smaller handwriting "a room they refused to leave", with a single stick figure standing inside a small hand-drawn room box. In the center, written large: "THE ROOTS 1999", and under it "dropped a album + a WEBSITE" with the word WEBSITE circled. Below that, the word "OKAYPLAYER" in big letters next to a simple hand-drawn computer screen box. Under that, "fans -> fans" with two stick figures facing each other and a speech bubble between them, then "talked all day" and "whole groups FOUND here" with an arrow pointing to a small box holding a cluster of three little stick figures. Lower on the page, two lines: "QUIT an artist" with a small X mark, and "DONT quit ya friends" with a small check mark, plus a circle drawn around the cluster of stick figures and the words "the BOND locks em in" with BOND underlined. At the bottom, "OPENED 1999" then beneath it in big letters "STILL HERE 25 YEARS LATER" with "25 YEARS" circled and underlined twice, and an arrow pointing to the lone stick figures still inside the room box. The background is pure white (#FFFFFF). The image is shot perfectly straight on, no angle, no shadow, no background elements. Pure white paper fills the entire 3:4 frame edge to edge.
