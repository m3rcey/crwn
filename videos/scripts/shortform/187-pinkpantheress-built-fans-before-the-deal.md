## PINKPANTHERESS BUILT THE FANS BEFORE THE DEAL

**CAPTION:**

PinkPantheress Built A Career On 90 Seconds

Link in bio to grow a fanbase that's yours before any label comes calling with CRWN. Free to start at thecrwn.app.
...
1. PinkPantheress Built A Career On 90 Seconds -- Structure 4  ← SUGGESTED
2. PinkPantheress Built Her Own Audience -- Structure 4
3. She Posted A Song Every Day For Free -- Structure 6
4. Free Clips Vs A Label Deal -- Structure 8
5. PinkPantheress Got Signed By A Snippet -- Structure 2

**TOPIC:** PinkPantheress built her fanbase free on TikTok with 90-second loops before signing; the audience was the asset, and it existed before any contract.
...
Flat scan of a white sheet of paper filling the entire frame. No desk, no surface, no edges visible, just white paper. Black sharpie marker handwriting. At the top in big bold capital letters "90 SECONDS" with a small simple clock drawn underneath it. To the right of the clock the words "NO DEAL YET" with a tiny contract page sketch crossed out with an X. Below that, underlined, the words "1 SONG A DAY". Beneath it a simple drawing of a phone with a play button triangle on its screen and the word "FREE" written next to the phone. Below, in quotation marks, "DAY 11". To the right a small hand-drawn flame with the word "PAIN" beside it. Under that, a row of four simple stick figures with smiley faces and the words "ALREADY HERS" written under them. To the right of the stick figures a right-pointing arrow leading to the text "APRIL 2021 - SIGNED". Below, a left-to-right arrow with the word "FANS" labeled 1 and the word "DEAL" labeled 2. To the right the text "#3 HOT 100" with a circle drawn around it. Below that the word "LABEL" with a line crossing it out. At the very bottom a box containing the words "THE FANS = THE ASSET" underlined twice. The background is pure white (#FFFFFF). The image is shot perfectly straight on, no angle, no shadow, no background elements. Pure white paper fills the entire 3:4 frame edge to edge.

---

**PAN ORDER:**

1. "90 SECONDS" with the clock at the top
2. "NO DEAL YET" with the crossed-out contract page
3. "1 SONG A DAY" underlined
4. Phone with play button and "FREE"
5. "DAY 11" in quotes
6. Flame with "PAIN"
7. Four stick figures with "ALREADY HERS"
8. Arrow to "APRIL 2021 - SIGNED"
9. The "FANS" 1 then "DEAL" 2 arrow
10. "#3 HOT 100" circled
11. Crossed-out "LABEL"
12. Boxed "THE FANS = THE ASSET" at the bottom
