## DOECHII BUILT THE FANS BEFORE THE DEAL

**CAPTION:**

Doechii Built Fans Before A Deal

Link in bio to grow your own audience so the offers chase you with CRWN. Free to start at thecrwn.app.
...
1. Doechii Built Fans Before A Deal -- Structure 4  ← SUGGESTED
2. Doechii Built A Crowd First -- Structure 6
3. Doechii Got Signed By Her Fans -- Structure 2
4. POV: Build People Then The Deal -- Structure 10
5. Fans First Vs Deal First -- Structure 8

**TOPIC:** Doechii built an independent fanbase for years before a label deal made sense; the audience came first and the offers chased her.
...
Flat scan of a white sheet of paper filling the entire frame. No desk, no surface, no edges visible, just white paper. Black sharpie marker handwriting. At the top, large bold handwritten text "DID IT BACKWARDS" with a big arrow pointing left underneath it. Below that, two simple stick figures: the left one running after a box labeled "LABEL", the right one standing in front of a small crowd of stick people, and that crowd is circled. In the middle left, the text "2016" next to a small drawing of a phone with tiny music notes, and under it the handwritten words "JUST HER + THE PEOPLE". To the right, a stick crowd drawn small then bigger with a small tag reading "TIKTOK" and a simple speaker icon with sound lines getting louder. Below that, a curved arrow pointing from the crowd toward a box labeled "LABEL" that is turned to face the crowd. Next to it the text "2022 TDE" and "FIRST WOMAN" with "FIRST WOMAN" circled. Lower on the page, large text "2025 BEST RAP ALBUM" with a small simple trophy drawing, and the words "3rd WOMAN EVER" with "3rd" circled. At the very bottom, large bold text "THE PEOPLE GOT THE DEAL" with the word "PEOPLE" underlined twice. The background is pure white (#FFFFFF). The image is shot perfectly straight on, no angle, no shadow, no background elements. Pure white paper fills the entire 3:4 frame edge to edge.

---

**PAN ORDER:**

1. "DID IT BACKWARDS" + left arrow (top)
2. Two stick figures: one chasing "LABEL" box, one with circled crowd
3. "2016" + phone with music notes + "JUST HER + THE PEOPLE"
4. Growing stick crowd + "TIKTOK" tag + louder speaker
5. Curved arrow from crowd to "LABEL" box turned toward her
6. "2022 TDE" + "FIRST WOMAN" (circled)
7. "2025 BEST RAP ALBUM" + trophy + "3rd WOMAN EVER" (3rd circled)
8. "THE PEOPLE GOT THE DEAL" with "PEOPLE" underlined twice (bottom)
