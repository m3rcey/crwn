## PHARRELL: OWN THE SONG, NOT JUST MAKE IT
...
1. Pharrell Made 5x More Owning It -- Structure 4  ← SUGGESTED
2. If You Make It Vs If You Own It -- Structure 8
3. Pharrell Got Paid 5x For Owning -- Structure 2
4. Producer Check Vs Owner Check -- Structure 8
5. Pharrell Built A Sound Into Brands -- Structure 6

**TOPIC:** Pharrell earned ~$4.3M owning the writing/publishing on Blurred Lines vs ~$860K for producing it, then turned his sound into owned brands. Lesson: own what you make, don't just get paid to make it.
...
Flat scan of a white sheet of paper filling the entire frame. No desk, no surface, no edges visible, just white paper. Black sharpie marker handwriting. At the top, handwritten "MAKE IT = PAID ONCE" with the word "ONCE" circled, and below it "OWN IT = PAID FOREVER" with "FOREVER" underlined. In the center, "PHARRELL" written large, with a hand-drawn sharpie head-and-shoulders portrait beside it capturing the recognizable likeness of Pharrell Williams from the attached photo reference, drawn in confident sharpie line work, not a generic stick figure, labeled "PHARRELL" underneath. To the left, "THE PRODUCER" with a simple drawing of a beat pad shown as four small squares. Below the center, "BLURRED LINES" with two stacked items under it: "PRODUCED" and "WROTE + PUBLISHING", a check mark beside "WROTE + PUBLISHING". A vertical line splits the lower half of the page into two columns: the left column labeled "PRODUCE" with "$860,000" written under it, the right column labeled "OWN" with "$4,300,000" written larger and circled. Between the two columns a large "5X" with an arrow pointing from the $860,000 side to the $4,300,000 side. Below that, "OWNS THE BRANDS TOO" with a small hand-drawn t-shirt. Near the bottom, "ONE CHECK" crossed out with "KEEPS PAYING" written next to it. At the very bottom, a boxed two-line note: "HIRED HAND = MAKES IT" and "OWNER = CASHES IT FOR YEARS". The background is pure white (#FFFFFF). The image is shot perfectly straight on, no angle, no shadow, no background elements. Pure white paper fills the entire 3:4 frame edge to edge.
