## 50 CENT OWNS THE SHOW

**CAPTION:**

How 50 Cent Got Richer From TV Than Rap

Link in bio to own what you make instead of just performing on it with CRWN. Free to start at thecrwn.app.
...
1. How 50 Cent Got Richer From TV Than Rap -- Structure 10  ← SUGGESTED
2. 50 Cent Built A Whole TV Universe -- Structure 6
3. Rap Check Vs Ownership Check -- Structure 8
4. 50 Cent Owned The 4th Show A Universe -- Structure 7
5. Every Spinoff Pays The Owner Not The Star -- Structure 5

**TOPIC:** 50 Cent makes more from owning the Power TV franchise than from rap, because the checks come to the owner, not just the performer.
...
Flat scan of a white sheet of paper filling the entire frame. No desk, no surface, no edges visible, just white paper. Black sharpie marker handwriting. At the top center, large bold handwritten "TV > RAP" with a hand-drawn circle around it. Directly under it the words "50 CENT" with a hand-drawn underline. On the left side a small simple microphone drawing. A hand-drawn arrow curving from the microphone to the right side of the page. In the center a boxed word "POWER" in bold capitals. Under the box the words "ACT + PRODUCE + OWN". Below that a stacked list reading "BOOK II", "BOOK III", "BOOK IV" with small arrows branching downward from the POWER box to each line, and a large hand-drawn circle enclosing the whole stack labeled "OWNS". On the left side "$17K / EPISODE" with a hand-drawn line crossing it out, and a tiny stick figure with a smiley face waving one arm. A small dollar sign on the left and a large bold dollar sign on the right with a circle around it. Near the bottom the words "PERFORMER = RENT" and beneath it "OWNER = THE BUILDING" with a hand-drawn box around the bottom line and a small simple drawing of a building beside it. The background is pure white (#FFFFFF). The image is shot perfectly straight on, no angle, no shadow, no background elements. Pure white paper fills the entire 3:4 frame edge to edge.

---

**PAN ORDER:**

1. "TV > RAP" circled at the top center
2. "50 CENT" underlined beneath it
3. Microphone drawing on the left
4. Arrow curving from the mic to the right
5. "POWER" boxed in the center
6. "ACT + PRODUCE + OWN" under the box
7. "BOOK II / BOOK III / BOOK IV" stacked list with branching arrows
8. Circle around the stack labeled "OWNS"
9. "$17K / EPISODE" crossed out on the left
10. Tiny stick figure waving
11. Small dollar sign on the left, big circled dollar sign on the right
12. "PERFORMER = RENT" then boxed "OWNER = THE BUILDING" with the building drawing
