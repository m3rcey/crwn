...
1. Wu-Tang Sold 1 Album For $2M -- Structure 4  ← SUGGESTED
2. Wu-Tang Got Paid $2M For One Copy -- Structure 2
3. Free Plays Vs One $2M Album -- Structure 8
4. Wu-Tang Made A $2 Million Album -- Structure 6
5. What 1 Copy Beat A Million Plays -- Structure 5

**TOPIC:** Wu-Tang pressed one copy of an album and sold it for ~$2M, proving scarcity plus ownership beats free plays.
...
Flat scan of a white sheet of paper filling the entire frame. No desk, no surface, no edges visible, just white paper. Black sharpie marker handwriting. At the top, large hand-drawn text reading "1 COPY" with a circle drawn around it. Below it the word "WU-TANG" in bold letters with a hand-drawn sharpie head-and-shoulders portrait capturing the recognizable likeness of RZA, Wu-Tang's founder, from the attached photo reference, drawn in confident sharpie line work, not a generic stick figure, labeled "RZA / WU-TANG" underneath, and a small simple "W" shield logo shape drawn beside it. Under that, "2015" and "31 SONGS" written in a row, then a large underlined number "1". The word "STREAM" written and crossed out with a single X. A small hand-drawn CD disc with a tiny padlock on it. A small box drawn with a padlock on the front, the word "AUCTION" beside it with an arrow pointing upward. In the center, the figure "$2,000,000" written large with two circles drawn around it. A small hand-drawn phone with a play-triangle button that has an X through it, next to the price. Lower down, "1,000,000 PLAYS = pennies" with a small word "FREE" written underneath. A simple hand-drawn balance scale: the left pan labeled "1,000,000 PLAYS" tipped up high, the right pan labeled "1 COPY $2M" tipped down heavy. At the very bottom, two lines of text: "A PLAY = THEY TAKE" and beneath it "ACCESS = YOU GIVE" with a hand-drawn box around the second line. The background is pure white (#FFFFFF). The image is shot perfectly straight on, no angle, no shadow, no background elements. Pure white paper fills the entire 3:4 frame edge to edge.

---

**PAN ORDER:**

1. Sharpie portrait of RZA labeled "RZA / WU-TANG"
2. "1 COPY" circled at top
3. "WU-TANG" with the small W logo
4. "2015" and "31 SONGS" and the big underlined "1"
5. "STREAM" crossed out, the locked CD
6. The locked box and "AUCTION" arrow
7. "$2,000,000" circled twice
8. The phone with the crossed-out play button
9. "1,000,000 PLAYS = pennies" and "FREE"
10. The scale tipping toward "1 COPY $2M"
11. "A PLAY = THEY TAKE" / "ACCESS = YOU GIVE" boxed at the bottom
