## NIPSEY LEFT A COMPANY, NOT A CATALOG

**CAPTION:**

What Nipsey Left His Kids Instead Of A Record Deal

Link in bio to build something you actually own and can pass down with CRWN. Free to start at thecrwn.app.
...
1. Nipsey Built A Business, Not A Catalog -- Structure 6  ← SUGGESTED
2. Nipsey Hussle Just Left A Company -- Structure 6
3. Nipsey Left A Business, Not A Deal -- Structure 4
4. Catalog Vs Company -- Structure 8
5. Owning Nipsey Hussle Down To The Block -- Structure 10

**TOPIC:** Nipsey Hussle didn't leave a catalog, he left a company (store, real estate, masters) his kids inherited as a business instead of a contract; for the avatar, own what you can pass down.
...
Flat scan of a white sheet of paper filling the entire frame. No desk, no surface, no edges visible, just white paper. Black sharpie marker handwriting. At the very top, the word "NIPSEY" written large in bold sharpie, with a simple hand-drawn portrait of Nipsey Hussle beside it (short beard, headband/durag, calm expression, shoulders visible). Below that, the word "CATALOG" crossed out with a single line, and next to it "COMPANY" written big and underlined twice. On the left mid-page, a small stick figure handing a music note to a larger box labeled "LABEL", with a small arrow showing money ($) flowing into the box. Center page, the boxed phrase "ALL MONEY IN" with a small drawing of a tape reel and a check mark beside it. To the right, a small storefront drawing labeled "MARATHON 2017", and below it a simple building shape circled with "OWNS THE BLOCK" written beside it. A short list reads "BARBERSHOP", "BURGERS", "PROPERTY" each with a check mark. Lower on the page, two small stick figures with "HIS KIDS" written above them, and a hand holding a set of keys with the word "KEYS" beside it. Three circled words: "STORE", "MASTERS", "BUILDING". Near the bottom, a drawing of a check with a chain and small lock over it. At the very bottom, the boxed phrase "WHAT YOU OWN IS WHAT YOU KEEP" with "THE KEYS" underlined just above it. The background is pure white (#FFFFFF). The image is shot perfectly straight on, no angle, no shadow, no background elements. Pure white paper fills the entire 3:4 frame edge to edge.

---

**PAN ORDER:**

1. "NIPSEY" title and the portrait of Nipsey Hussle at the top
2. "CATALOG" crossed out, "COMPANY" underlined
3. Stick figure handing a note to the "LABEL" box, money arrow into the box
4. Boxed "ALL MONEY IN" with tape reel and check mark
5. "MARATHON 2017" storefront drawing
6. Building shape circled, "OWNS THE BLOCK"
7. The list: "BARBERSHOP / BURGERS / PROPERTY" with check marks
8. Two stick figures with "HIS KIDS" above them
9. Hand holding "KEYS"
10. Circled "STORE", "MASTERS", "BUILDING"
11. Check with a chain and lock over it
12. Bottom boxed line "WHAT YOU OWN IS WHAT YOU KEEP" with "THE KEYS" underlined
