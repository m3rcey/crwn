## JOEY BADA$$ — INDEPENDENT, AND AN OSCAR ON TOP

**CAPTION:**

Rap Money Bought An Oscar
...
So watch the math change. One audience, but the money come from the song, the show, and the screen. Three lanes feedin one artist.

Then it really hit. That little film he starred in won a real Academy Award. A rapper with no label sittin next to an Oscar.

---

**TITLES (suggested is in CAPTION above; alternates below):**
1. Rap Money Bought An Oscar -- Structure 4  ← SUGGESTED
2. If You Got One Check, You Broke -- Structure 3
3. Joey Stacked A Second Career -- Structure 4
4. One Fanbase Vs Three Checks -- Structure 8
5. Joey Won A Real Academy Award -- Structure 4

**TOPIC:** Joey Bada$$ stayed independent through Pro Era and stacked rap, TV, and film into one career, capped by an Oscar-winning short.
...
**RISING ACTION:** It moved like 57,000 copies that first week and landed top 5 on the chart. As an independent. With no big radio single pushin it. [Write "~57,000 / WEEK 1" and "TOP 5" boxed. Draw a small chart with a #5 marked, no radio tower (draw a crossed-out radio tower next to it).] Now most rappers stop right there. They chase the next song. [Draw a stick figure running in a loop chasing a music note.] Joey took the same name the music built and walked it into acting. TV. Film. A second check the rap opened the door to. [Fill the first box "MUSIC", second box "TV", third box "FILM". Draw a door between music and TV.]

**TWIST:** So watch the math change. One audience, but the money come from the song, the show, and the screen. Three lanes feedin one artist. [Draw one stick figure labeled "1 CROWD" with three arrows feeding into it from "SONG", "SHOW", "SCREEN".] Then it really hit. That little film he starred in won a real Academy Award. A rapper with no label sittin next to an Oscar. [Draw a small Oscar statue at the bottom. Next to it write "OSCAR" big, circle it. Write "NO LABEL" with an arrow to the statue.]

**PAYOFF:** [Box the closing idea at the very bottom: "ONE NAME. THREE CHECKS." Underline "THREE CHECKS".] One name fed three different checks, and the label aint touch none of it.
...
6. Stick figure running in a loop chasing a music note
7. Three boxes "MUSIC", "TV", "FILM" with the door
8. "1 CROWD" stick figure with three arrows from "SONG", "SHOW", "SCREEN"
9. Oscar statue with "OSCAR" circled and "NO LABEL" arrow
10. Boxed "ONE NAME. THREE CHECKS." at the bottom
