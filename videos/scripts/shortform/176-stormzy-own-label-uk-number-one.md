## STORMZY OWNED THE LABEL, THE MAJOR JUST DELIVERED IT

**CAPTION:**

Stormzy Built A Label And Beat Them

Link in bio to own your masters and your fans instead of renting both to a label with CRWN. Free to start at thecrwn.app.
...
First grime album to ever top that chart. And the first independent one too.
...
1. Stormzy Built A Label And Beat Them -- Structure 4  ← SUGGESTED
2. Stormzy Got #1 By Owning It -- Structure 2
3. Stormzy Owned The Shelf, Rented The Truck -- Structure 6
4. Own The Label Vs Sign To One -- Structure 8
5. Stormzy Built A Number One Label -- Structure 4

**TOPIC:** Stormzy hit a UK #1 on his own #Merky Records with a major only distributing, owning the masters, the company, and the fans.
...
Flat scan of a white sheet of paper filling the entire frame. No desk, no surface, no edges visible, just white paper. Black sharpie marker handwriting. At the top large bold "#1 UK", and beside it a small rectangle labeled "LABEL" with a big X through it and the words "NO MAJOR". Below that the underlined phrase "THE PART LABELS HIDE". In the upper middle "GANG SIGNS & PRAYER 2017" with "68,000 WEEK 1" under it and the number 68,000 circled. Beside it two stacked lines "1ST GRIME #1" and "1ST INDIE #1" each with a check mark. A crossed-out "MAJOR LABEL" with "#MERKY RECORDS" written next to it inside a hand-drawn box. In the middle a simple drawing of a delivery truck with "JUST THE TRUCK" written under it, and a tiny circle with one thin pie slice marked "small cut". A stacked checklist reading "MASTERS - HIS", "COMPANY - HIS", "FANS - HIS" with a check mark beside each line. Lower down a simple shelf drawing with a sad stick figure handing a box away labeled "HAND OVER ALL 3", and a happy stick figure standing on a shelf with a boxed phrase "OWN THE SHELF / RENT THE TRUCK". At the bottom two rooms side by side: a small room of stick figures labeled "$ DIRECT" with a check mark and circled, and a larger room labeled "RENTED" with an X. The background is pure white (#FFFFFF). The image is shot perfectly straight on, no angle, no shadow, no background elements. Pure white paper fills the entire 3:4 frame edge to edge.

---

**PAN ORDER:**

1. "#1 UK" with the X'd-out "LABEL" box and "NO MAJOR" (top)
2. Underlined "THE PART LABELS HIDE"
3. "GANG SIGNS & PRAYER 2017" with circled "68,000 WEEK 1"
4. "1ST GRIME #1" and "1ST INDIE #1" with check marks
5. Crossed-out "MAJOR LABEL" and boxed "#MERKY RECORDS"
6. Delivery truck with "JUST THE TRUCK" and the small-cut pie slice
7. Stacked checklist "MASTERS - HIS / COMPANY - HIS / FANS - HIS"
8. Shelf with sad stick figure handing a box away, "HAND OVER ALL 3"
9. Happy stick figure on the shelf, boxed "OWN THE SHELF / RENT THE TRUCK"
10. Two rooms at the bottom: small "$ DIRECT" room circled vs big "RENTED" room with an X
