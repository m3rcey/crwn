## LARRY JUNE — THE ARTIST AS THE COMPANY
...
1. Larry June Made The Song A Door -- Structure 4  ← SUGGESTED
2. Larry June Built A Whole Company -- Structure 4
3. This Is How You Become The Company -- Structure 10
4. Every Song Sells Something Bigger -- Structure 5
5. Larry June Made His 1st Real Asset -- Structure 7

**TOPIC:** Larry June runs an independent music career as one piece of a self-owned business empire, with the music acting as the entry point to brands he owns.
...
Flat scan of a white sheet of paper filling the entire frame. No desk, no surface, no edges visible, just white paper. Black sharpie marker handwriting. At the top, the word "RAPPER" in large bold letters with a hand-drawn arrow pointing right to the word "COMPANY," and "COMPANY" is circled. Beside the heading, a hand-drawn sharpie head-and-shoulders portrait capturing the recognizable likeness of Larry June from the attached photo reference, drawn in confident sharpie line work, not a generic stick figure, labeled "LARRY JUNE" underneath. Just below, the words "HIT SONG" written small and crossed out, with a tiny question mark beside it. Below that, "LARRY JUNE" written large with "INDEPENDENT" underlined underneath it. To the right, a short list reading "Good Job" and "Numbers" each with a checkmark. In the middle of the page, "THE GREAT ESCAPE 2023" with "#32 BILLBOARD" and "#4 INDIE" stacked beneath it, and the words "OWNS MASTERS" inside a hand-drawn box. Lower on the page, a simple hand-drawn house with a single door, the door labeled "MUSIC," with three arrows leading from the door to three small boxes labeled "BOBA SHOP," "CLOTHING," and "MERCH." A simple stick figure with a smiley face is drawn walking through the door toward the boxes. Near the bottom, "SONG = 1 WEEK" with a small clock drawing, and beneath it "CUSTOMER = FOREVER" with "FOREVER" underlined. At the very bottom, a boxed phrase reading "HE OWNS THE WHOLE BUILDING." The background is pure white (#FFFFFF). The image is shot perfectly straight on, no angle, no shadow, no background elements. Pure white paper fills the entire 3:4 frame edge to edge.

---

**PAN ORDER:**

1. Sharpie portrait of Larry June labeled "LARRY JUNE"
2. "#4 INDIE" big with a question mark at the top
3. "LARRY JUNE" with "INDEPENDENT" underlined
4. "Good Job" / "Numbers" checklist
5. "THE GREAT ESCAPE 2023" with "#32 BILLBOARD" and "#4 INDIE"
6. "OWNS MASTERS" boxed
7. "JUST A RAPPER?" with question mark
8. "SONG = 1 WEEK" with clock
9. "CUSTOMER = FOREVER" underlined
10. The house with the door labeled "MUSIC"
11. Arrows from the door to "BOBA SHOP," "CLOTHING," "MERCH"
12. Stick figure walking through the door
13. Boxed bottom line "HE OWNS THE WHOLE BUILDING"
