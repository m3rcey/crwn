## LUDACRIS — LABEL TO FILM AND BUSINESS EMPIRE
...
1. POV: You Built A Company, Not A Career -- Structure 10  ← SUGGESTED
2. Ludacris Co-Built A Whole Empire -- Structure 6
3. The Rap Vs The Company It Built -- Structure 8
4. Ludacris Opened A 7 Billion Door -- Structure 4
5. If You Own The Label, You Own The Room -- Structure 3

**TOPIC:** Ludacris co-founded Disturbing Tha Peace, the seat got him into Fast & Furious, and the music became the front door to a film and business empire.
...
Flat scan of a white sheet of paper filling the entire frame. No desk, no surface, no edges visible, just white paper. Black sharpie marker handwriting. At the top left, the words "THE RAP" with a small simple hand-drawn microphone beneath them. A large arrow points to the right toward the words "THE DOOR?" written in big bold capital letters. Above the arrow a hand-drawn sharpie head-and-shoulders portrait capturing the recognizable likeness of Ludacris from the attached photo reference, drawn in confident sharpie line work, not a generic stick figure, labeled "LUDACRIS" underneath. Beneath "THE DOOR?" the word "LUDACRIS" is written and circled. In the middle of the page: "1998" with "DISTURBING THA PEACE" under it and a small rectangular box labeled "LABEL". The word "ROSTER" is crossed out and "OWNER" is written beside it with a check mark. Below that: "2003" then "FAST & FURIOUS" with a small simple hand-drawn car and "x7" written next to it. In the lower middle, very large and bold and underlined twice: "$7,000,000,000". Beside it a small hand-drawn globe with a tiny smiling stick figure standing on top. Lower on the page: "3 GRAMMYS" written small with a hand-drawn trophy that has an X drawn over it, and next to it a bigger box labeled "COMPANY" that is circled. A simple hand-drawn door labeled "MUSIC" with an arrow passing through it. At the very bottom: "THE SONG = THE DOOR" and beneath it, inside a box, "$7 BILLION ON THE OTHER SIDE". The background is pure white (#FFFFFF). The image is shot perfectly straight on, no angle, no shadow, no background elements. Pure white paper fills the entire 3:4 frame edge to edge.
