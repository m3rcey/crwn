...
Flat scan of a white sheet of paper filling the entire frame. No desk, no surface, no edges visible, just white paper. Black sharpie marker handwriting. At the top, "T-PAIN" written large, with a hand-drawn sharpie head-and-shoulders portrait capturing the recognizable likeness of T-Pain from the attached photo reference, drawn in confident sharpie line work, not a generic stick figure, labeled "T-PAIN" underneath, and "-$40,000,000" written under it and circled. To the right of the name, a small hand-drawn radio with sound waves coming out, and a downward arrow pointing to a dollar sign with a question mark. Below that, "9 TOP 10s" written and drawn inside a box. Under it, a short column of five names with a check mark beside each: "PLIES", "KANYE", "LIL WAYNE", "JAMIE FOXX", "PITBULL", with small arrows running from the names back toward a big "$" drawn in the center. A small open book or ledger drawn nearby. The three words "INVESTMENTS", "REAL ESTATE", "SPENDING" written in a stack, each one crossed out with an X. A tiny hand-drawn hamburger with a small sad stick figure beside it. The word "BROKE" written large and circled. Lower on the page, one stick figure on the left connected by a straight line labeled "DIRECT" to three smaller stick figures labeled "FANS". A hand-drawn pie chart with a large shaded slice labeled "LABEL 85%" and a thin sliver labeled "HIM 15%". At the very bottom, a vertical line dividing the page: on the left a small radio with the word "HIM", on the right a stack of dollar bills with the word "LABEL". The background is pure white (#FFFFFF). The image is shot perfectly straight on, no angle, no shadow, no background elements. Pure white paper fills the entire 3:4 frame edge to edge.
