## NBA YOUNGBOY GOT HUGE WITH NO RADIO

**CAPTION:**

NBA YoungBoy Got Big With No Radio

Link in bio to build a direct audience that shows up no matter what radio does with CRWN. Free to start at thecrwn.app.
...
1. NBA YoungBoy Got Big With No Radio -- Structure 2  ← SUGGESTED
2. NBA YoungBoy Made A Direct Empire -- Structure 6
3. The Gatekeepers Vs Your Fans -- Structure 8
4. Would You Win With No Radio -- Structure 1
5. Every Gatekeeper Lost To The Fans -- Structure 5

**TOPIC:** NBA YoungBoy became YouTube's most-streamed rapper for years and has the most gold songs in history almost entirely without radio; a direct fan channel beats the gatekeepers.
...
Flat scan of a white sheet of paper filling the entire frame. No desk, no surface, no edges visible, just white paper. Black sharpie marker handwriting. At the top, "NO RADIO" with an X drawn over a small radio, and "STILL #1". "YOUTUBE'S #1 RAPPER", "5 YEARS STRAIGHT", "15 BILLION+ VIEWS". "MOST GOLD SONGS EVER" with three small stick figures labeled "ARIANA", "ED", "MJ" joined by a "+" then a "<" pointing to "NBA YB". The words "RADIO", "COVERS", "PUSH" each crossed out. A closed gate labeled "GATEKEEPERS" crossed out, and an open door with a crowd of stick figures walking straight through to a single stick figure. At the bottom, a boxed phrase "RADIO PICKED WINNERS / NOW DIRECT FANS DO". The background is pure white (#FFFFFF). The image is shot perfectly straight on, no angle, no shadow, no background elements. Pure white paper fills the entire 3:4 frame edge to edge.

---

**PAN ORDER:**

1. "NO RADIO" + crossed-out radio + "STILL #1" (top)
2. "YOUTUBE'S #1 RAPPER / 5 YEARS STRAIGHT / 15 BILLION+ VIEWS"
3. "MOST GOLD SONGS EVER" + ARIANA/ED/MJ "+" "<" "NBA YB" + crossed-out RADIO/COVERS/PUSH
4. Crossed-out "GATEKEEPERS" gate + open door with crowd to figure
5. Boxed "RADIO PICKED WINNERS / NOW DIRECT FANS DO" (bottom)
