## Berner: One Audience, Many Streams

**CAPTION:**

If Your Fans Buy More Than Music

Link in bio to get paid more than one way from the same fanbase with CRWN. Free to start at thecrwn.app.
...
1. If Your Fans Buy More Than Music -- Structure 3  ← SUGGESTED
2. Berner Sold One Crowd Everything -- Structure 4
3. Every Fan Streams And Buys -- Structure 5
4. Berner Built A Second Paycheck -- Structure 6
5. Music Vs The Brand It Sells -- Structure 8

**TOPIC:** Berner sold music and a cannabis brand to the same fanbase he owned, proving one audience can pay an artist many different ways.
...
Flat scan of a white sheet of paper filling the entire frame. No desk, no surface, no edges visible, just white paper. Black sharpie marker handwriting. At the top left "1 THING SOLD" with a long arrow pointing right to "$$$ LEFT BEHIND" with a light single line crossed through it. At the top right, a hand-drawn sharpie head-and-shoulders portrait capturing the recognizable likeness of Berner from the attached photo reference, drawn in confident sharpie line work, not a generic stick figure, labeled "BERNER" underneath. Below that the word "BERNER" written large and underlined twice. To the left a simple stick figure holding a microphone labeled "RAPPER", and beside it "BERN ONE". In the center the word "MUSIC" with a downward arrow to the word "MARKETING", and off to the right a boxed word "COOKIES". Below, a hand-drawn circle labeled "SAME FANS" with three arrows leaving it to the words "SONGS", "VIDEOS", and "TOUR BUS". Near it the words "OWNS A PIECE" with a circle drawn around them. Lower on the page a second hand-drawn circle labeled "SAME FANS" with four arrows leaving it to the words "VINYL", "VERSE", "CRITIQUE", and "CALL". Near the bottom "1 FANBASE" then an equals sign leading to a stack of four dollar signs "$ $ $ $". At the very bottom a boxed phrase "EVERY PAYCHECK YOU OFFER". The background is pure white (#FFFFFF). The image is shot perfectly straight on, no angle, no shadow, no background elements. Pure white paper fills the entire 3:4 frame edge to edge.
