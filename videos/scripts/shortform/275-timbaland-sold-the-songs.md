...
1. Timbaland Sold The Songs -- Structure 4  ← SUGGESTED
2. A Bank Bought 108 Of His Songs -- Structure 2
3. Beat Vs Catalog -- Structure 8
4. Timbaland Sold A 108-Song Catalog -- Structure 6
5. Would A Fund Buy Your Songs -- Structure 1

**TOPIC:** Timbaland sold his producer catalog to a fund; the songs are the asset, and the lesson for the artist is to own a catalog worth keeping.
...
Flat scan of a white sheet of paper filling the entire frame. No desk, no surface, no edges visible, just white paper. Black sharpie marker handwriting. At the very top, a hand-drawn sharpie head-and-shoulders portrait capturing the recognizable likeness of Timbaland from the attached photo reference, drawn in confident sharpie line work, not a generic stick figure, labeled "TIMBALAND" underneath. Below it a vertical line down the middle of the upper section: on the left the words "A BEAT" with a tiny music note, on the right the word "PAYCHECK" with a dollar sign and "+20 YRS" beneath it. Below that, the word "TIMBALAND" written large, with "2019" circled under it and a small arrow pointing right to the word "SOLD". Below that, a simple hand-drawn bank building with a "$" on its front and an arrow pointing from the bank to a small music note labeled "MONEY MACHINE". On the left a stick figure with empty open hands labeled "ARTIST = $0 TO SELL", on the right a box labeled "LABEL" holding a music note with a dollar sign. Then "OWNED IT FIRST" written large inside a hand-drawn box. Below that, on the left the word "STREAM" with a music note fading into a small puff of smoke, on the right the words "OWN IT" underlined with "$ $ $" under a drawing of a closed sleeping eye. Below that, "$ = ???" with the question marks crossed out, and "OLD SONGS PAY FOREVER" underneath with the word "FOREVER" underlined. At the very bottom, "100%" written large and circled, with "108 SONGS" underlined beneath it, then a column of four names: "JUSTIN TIMBERLAKE", "MISSY ELLIOTT", "NELLY FURTADO", "DRAKE", all enclosed in one hand-drawn box, with "1 DEAL" written beside the box. All text is hand-drawn black sharpie, no typeset fonts anywhere. The background is pure white (#FFFFFF). The image is shot perfectly straight on, no angle, no shadow, no background elements. Pure white paper fills the entire 3:4 frame edge to edge.
