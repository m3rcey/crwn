## DMX HAD 5 STRAIGHT #1S. THE LABEL HAS THE MASTERS.
...
1. DMX Made The Hits. The Label Owns The Recordings. -- Structure 6  ← SUGGESTED
2. The Catalog Outlived Him. He Never Owned It. -- Structure 8
3. 5 #1 Albums, Zero Masters -- Structure 6
4. Who Does Your Music Pay After You're Gone -- Structure 1
5. He Filled The Vault And Never Got The Key -- Structure 8

**TOPIC:** DMX stacked #1, multi-platinum albums but the masters sat with the Ruff Ryders/Def Jam side. The catalog still earns daily after his death, paying the owners first. A hit proves authorship; owning the master decides who it pays.
...
Flat scan of a white sheet of paper filling the entire frame. No desk, no surface, no edges visible, just white paper. Black sharpie marker handwriting. The dominant central illustration: a DMX figure in the center holding a microphone and standing in front of a stack of three "#1" plaques he made, reaching toward a huge bank vault labeled "MASTERS - DEF JAM / RUFF RYDERS" that holds all his records, but a label hand dangles the vault KEY just out of his reach; an arrow shows stream money flowing into the vault first, with only a thin trickle reaching the artist. At the very top in large hand-lettered black sharpie capitals (thick uneven hand-drawn marker strokes, NOT a printed, bold, or display font): "5 #1 ALBUMS", with "0 MASTERS" under it. Small support text: "HIT = you made it", "MASTER = who it pays". At the bottom, smaller and underlined twice: "HE FILLED THE VAULT, NEVER GOT THE KEY". The background is pure white (#FFFFFF). Shot perfectly straight on, no angle, no shadow, no background elements. Pure white paper fills the entire 3:4 frame edge to edge.

---

**PAN ORDER:**

1. "ALBUMS: #1, #1, #1" / "MASTERS: not his"
2. Plaque with question mark
3. "HE MADE IT" → "THEY HOLD IT (the master)"
4. "STREAM $" → "OWNS MASTERS" box → thin arrow to "ARTIST/ESTATE"
5. Vault with records, key outside crossed out
6. "HIT = YOU MADE IT" / "MASTER = WHO IT PAYS" underlined twice
