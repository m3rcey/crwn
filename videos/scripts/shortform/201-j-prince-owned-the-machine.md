## J PRINCE OWNED THE MACHINE

**CAPTION:**

J Prince Owned A Whole Machine

Link in bio to own your label instead of renting one from a major with CRWN. Free to start at thecrwn.app.
...
1. J Prince Owned A Whole Machine -- Structure 6  ← SUGGESTED
2. J Prince Built A Lane Nobody Owned -- Structure 4
3. Every Major Wanted J Prince's Label -- Structure 5
4. Would J Prince Sell His Masters? -- Structure 1
5. Renting A Label Vs Owning One -- Structure 8

**TOPIC:** J Prince built Rap-A-Lot as a fully owned independent in Houston, used majors only for distribution, and kept the company while others sold theirs.
...
Flat scan of a white sheet of paper filling the entire frame. No desk, no surface, no edges visible, just white paper. Black sharpie marker handwriting. At the top center in large bold block letters: "ANSWERED TO NOBODY" with the word "NOBODY" circled, and just under it smaller text "→ Drake?" with a question mark. On the upper left, handwritten "1986 · RAP-A-LOT · HOUSTON". Below that a small hand-drawn building box labeled "HIS" with a check mark beside it. To the right, a box labeled "MAJORS" with an arrow pointing toward the building, the arrow stopping at a short drawn wall. Underneath, the underlined words "DISTRIBUTION ONLY". Below that a short list "GETO BOYS / SCARFACE" with a hand-drawn bracket pointing to the words "HIS HOUSE". A simple drawn key, circled, with the crossed-out word "MASTERS" beside it marked with an X. In the center: "SON → found DRAKE, 2008" with an arrow from "DRAKE" to the words "CASH MONEY". Near it a tangled knot of scribbled lines around a dollar sign. At the bottom, large, two stacked lines: "OWN THE LANE" above a crossed-out "RENT THE LANE", and a hand-drawn box around both lines. The background is pure white (#FFFFFF). The image is shot perfectly straight on, no angle, no shadow, no background elements. Pure white paper fills the entire 3:4 frame edge to edge.

---

**PAN ORDER:**

1. "ANSWERED TO NOBODY" with NOBODY circled (top center)
2. "→ Drake?" line under it
3. "1986 · RAP-A-LOT · HOUSTON" (upper left)
4. building box labeled "HIS" with check mark
5. "MAJORS" box, arrow stopping at the wall
6. "DISTRIBUTION ONLY" underlined
7. "GETO BOYS / SCARFACE" bracket to "HIS HOUSE"
8. the key, circled, with crossed-out "MASTERS" + X
9. "SON → found DRAKE, 2008"
10. arrow from "DRAKE" to "CASH MONEY"
11. tangled knot around the dollar sign
12. "OWN THE LANE" over crossed-out "RENT THE LANE", boxed (bottom)
