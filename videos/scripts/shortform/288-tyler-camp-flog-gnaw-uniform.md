## TYLER, THE CREATOR — THE FANS MADE A UNIFORM
...
1. Tyler Gave His Fans A Flag -- Structure 4  ← SUGGESTED
2. Tyler Built A Uniform For Fans -- Structure 6
3. Every Hoodie Was A Handshake -- Structure 5
4. Merch Vs Movement -- Structure 8
5. Turning Fans Into A Tribe -- Structure 10

**TOPIC:** Tyler's Golf Wang and Camp Flog Gnaw became a fan uniform and meetup; give fans a signal and they build the culture and find each other.
...
Flat scan of a white sheet of paper filling the entire frame. No desk, no surface, no edges visible, just white paper. Black sharpie marker handwriting. At the top center the bold words "GIVE FANS A COLOR" with "COLOR" underlined twice, and beside it a hand-drawn sharpie head-and-shoulders portrait capturing the recognizable likeness of Tyler, the Creator from the attached photo reference, drawn in confident sharpie line work, not a generic stick figure, labeled "TYLER, THE CREATOR" underneath. Below, a small stick figure wearing a hoodie that is circled. On the left side the text "2011 - GOLF WANG" with a simple hand-drawn hoodie beside it that has a small flower on the chest, plus a tiny donut and a sock drawn next to it. In the middle the word "MERCH" crossed out with a single line and the word "UNIFORM" written under it in capitals inside a box. To the right two matching stick figures both wearing hoodies with an arrow pointing between them, and a small empty speech bubble with an X through it. Center text "CAMP FLOG GNAW" with a simple ferris wheel drawn beside it. Below that a cluster of five tiny stick figures grouped inside a hand-drawn circle. The phrase "FANS = STREET TEAM" circled, with arrows drawn from one stick figure to two more. The word "HANDSHAKE" with two simple hands drawn shaking, and the word "MEETUP" with a map pin drawn beside it. In the center the big underlined words "YO SIGNAL?" and a simple flag on a pole. At the bottom the boxed phrase "THEY BUILD IT" with three small "Z Z Z" marks drawn above it. The background is pure white (#FFFFFF). The image is shot perfectly straight on, no angle, no shadow, no background elements. Pure white paper fills the entire 3:4 frame edge to edge.

---

**PAN ORDER:**

1. Sharpie portrait of Tyler, the Creator labeled underneath
2. "GIVE FANS A COLOR" with "COLOR" underlined twice (top center)
3. Stick figure in a circled hoodie
4. "2011 - GOLF WANG" with hoodie and flower
5. Tiny donut and sock
