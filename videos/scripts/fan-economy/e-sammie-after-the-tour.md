# Sammie's tour crowd walks out the door as strangers
...
a membership for the grown fans, the between-tour content, first word on the next run.
The show ends. The relationship shouldnt.
...
And the cold part is what happens to everybody else.
