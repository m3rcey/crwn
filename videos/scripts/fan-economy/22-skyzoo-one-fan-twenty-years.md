# Skyzoo: what one fan who never leaves is actually worth
...
So how does that work? Because on paper it shouldnt.
Every plan you get handed says you need a hit, and a hit means reach, and reach means the whole world hearing you one time.

But look at what Skyzoo actually has instead.
The same people, buying the next one. For twenty years.
Not a wave that came and went. A group that never left.
...
When I lined it up next to a streaming number it stopped being close.
...
So one fan who never leaves is worth almost a million streams.
And here is the part that reorganizes everything: you can NOT go find 800,000 streams on purpose. That is a lottery ticket.
...
Repost test: Skyzoo WINS throughout; "no hit single" is framed as the whole point of the story, not a shortfall, and no foil artist is named
