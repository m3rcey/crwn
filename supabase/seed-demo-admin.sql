...
FOR v_i IN 1..25 LOOP
  ...
  -- profiles
  INSERT INTO profiles (id, role, display_name, username, last_active_at, created_at, updated_at)
  VALUES (
...
INSERT INTO profiles (id, role, display_name, username, last_active_at, created_at, updated_at)
VALUES
  (v_rec_1, 'fan', 'Tanya Bridges', 'tanyabridges', NOW() - INTERVAL '2 days', NOW() - INTERVAL '90 days', NOW()),
  (v_rec_2, 'fan', 'Derek Osman', 'derekosman', NOW() - INTERVAL '5 days', NOW() - INTERVAL '80 days', NOW()),
  (v_rec_3, 'fan', 'Camille Frost', 'camillefrost', NOW() - INTERVAL '1 day', NOW() - INTERVAL '60 days', NOW()),
  (v_rec_4, 'fan', 'Jaylen Scott', 'jaylenscott', NOW() - INTERVAL '8 days', NOW() - INTERVAL '45 days', NOW())
ON CONFLICT (id) DO NOTHING;
