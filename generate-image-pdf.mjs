...
const IMG_DIR = '/mnt/c/Users/Josh/Dropbox/nano banana output/Shortform Posts/Hip-Hop Industry';
const START = 48;
const END = 170;
const OUT_PDF = `/mnt/c/Users/Josh/Dropbox/nano banana output/Shortform Posts/Hip-Hop Industry ${START}-${END}.pdf`;
