...
- **A SINGLE-OFFER entry tool still gets the full ladder, and now gets told why.** Three tools
  ...
  the release waterfall staggers on). If you add a calculator that models ONE offer, add it here or
  its artists confirm four tiers with nothing arguing for them.
