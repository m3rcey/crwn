...
const OUTPUT_BASE = "/mnt/c/Users/Josh/Dropbox/nano banana output";
const REFS_DIR = "/mnt/c/Users/Josh/Desktop/nano banana references";
const OUT_PATH = path.join(OUTPUT_BASE, "how-crwn-works-partner-pitch.jpg");
...
const PROMPT = `Flat scan of a white sheet of paper filling the entire frame. No desk, no surface, no edges visible, just white paper. Black sharpie marker handwriting and hand-drawn icons. A clean two-part explainer poster, clear visual hierarchy.

At the very top, a large hand-lettered black sharpie headline in capitals (thick uneven hand-drawn marker strokes, NOT a printed or display font), double-underlined: "HOW CRWN WORKS & WHAT'S IN IT FOR YOU".

Below the headline the page is split into two columns by one vertical hand-drawn divider line down the middle.

LEFT COLUMN, header underlined: "THE ARTIST". Under it a simple sharpie figure of an artist singing into a microphone. Hand-written bullet lines: "Posts music, livestreams, products", "Fans subscribe & buy DIRECT" with the word DIRECT circled, "Keeps 88-92%", "Paid out weekly". Beneath the bullets a small hand-drawn arrow flow: a stick-figure artist, then an arrow to a little cluster of 3 fan stick figures handing over dollar bills, then an arrow to a big dollar sign pointing straight back to the artist.

RIGHT COLUMN, header underlined: "YOU (THE CONNECTOR)". Under it a sharpie figure shaking hands with an artist and pointing toward a doorway. Hand-written bullet lines: "You introduce an artist", "They join & go live", "You get paid to your Stripe, automatic". Then a hand-drawn box around large hand-lettered text "$100 PER ARTIST", with smaller writing underneath "after they stay 30 days". Below that a large hand-lettered line "+ 1% OF THEIR FAN REVENUE, every month" with the words "every month" underlined.

BOTTOM, a wide hand-drawn rectangular box spanning the full width of the page, header inside it underlined: "THE MATH". Hand-written lines stacked inside: "Bring 5 artists doing $20K/mo each", "$100 x 5 = $500 up front", "1% of $100K = $1,000 / MONTH" with "$1,000 / MONTH" circled, and a final larger hand-lettered line "More artists + bigger fans = bigger checks".
...
console.log("Generating partner-pitch explainer image...");
